    ...
    >
      ...
      >
        ...
        {checkRouleProfileAccess(groupsUser, roules.sales) && (
          <Menu.Item key={'/dre'} icon={<LineChartOutlined />}>
        ...
        {checkRouleProfileAccess(groupsUser, roules.contracts) && (
          <SubMenu
            key={`sub-/${appRoutes.contracts}`}
            title={'Contratos'}
            icon={<FileDoneOutlined />}
          >
            <Menu.Item key={`/${appRoutes.contracts}`}>
              <Link to={`/${appRoutes.contracts}`}>Lista</Link>
            </Menu.Item>
            <Menu.Item key={`/${appRoutes.contracts}/create`}>
              <Link to={`/${appRoutes.contracts}/create`}>Novo</Link>
            </Menu.Item>
          </SubMenu>
        )}
        {checkRouleProfileAccess(groupsUser, roules.sales) && (
        ...
        {checkRouleProfileAccess(groupsUser, roules.suppliers) && (
          <SubMenu
            key={`sub-/${appRoutes.suppliers}`}
            title="Fornecedores"
            icon={<UserOutlined />}
          >
            <Menu.Item key={`/${appRoutes.suppliers}`}>
              <Link to={`/${appRoutes.suppliers}`}>Lista</Link>
            </Menu.Item>
            <Menu.Item key={`/${appRoutes.suppliers}/create`}>
              <Link to={`/${appRoutes.suppliers}/create`}>Novo</Link>
            </Menu.Item>
          </SubMenu>
        )}
